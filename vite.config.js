...
// If you are deploying to https://<USERNAME>.github.io/<REPO>/ (eg. your repository 
// is at https://github.com/<USERNAME>/<REPO>), then set base to '/<REPO>/'.
